...
function DropMenu({
  ...
  return (
    <div className="dropContainer">
      <div
        className={
          dropBox === "colorList" ? "triangle colorList" : "triangle colorRGB"
        }
      />
      {dropBox === "colorList" && (
        ...
        <div className="rgbColors">
          ...
          <div className="rangeButtonContainer">
            <Button
              ...
              title={"CANCEL"}
              titleColor={"grey"}
              onClick={closeToDropBox}
            />
            <Button
              color={"green"}
              title={"OK"}
              titleColor={"white"}
              onClick={updateColorFromRGB}
            />
          </div>
        </div>
      )}
